...
gui.addColor(params, "color").onFinishChange(function (value) {
    new_color = value;
    mesh.material.color.setHex(new_color);
    wireframe.material.color.setHex(new_color);
});
...
var incremental_unit_scale_factor = 0.25;
var incremental_time_for_scale = 1;
...
var geometry = new THREE.TextGeometry(current_string,
    {
        font: font, size: current_size, height: 10, material: 0, bevelEnabled: false, bevelThickness: 0, bevelSize: 0, extrudeMaterial: 1, curveSegments: 10
...
function render() {
    ...
    {
        var current_rotationx = mesh.rotation.x;
        var current_rotationy = mesh.rotation.y;
        ...
        //mesh.position.z = -100;
        //mesh.position.x = 100;
        mesh.rotation.x = current_rotationx;
        mesh.rotation.y = current_rotationy;
        scene.add(mesh);
